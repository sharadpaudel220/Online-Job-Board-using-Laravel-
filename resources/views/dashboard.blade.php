<x-app-layout>
    ...
    <div class="-my-6">
        ...
        <a 
        href="{{route('listing.show', $listing->slug)}}" 
        ...
        <div class="md:w-1/2 mr-8 flex flex-col items-start justify-center ">
            ...
            <p class="leading-relaxed text-gray-900"> {{$listing->company}} &mdash; <span class="text-gray-600">{{$listing->location}}</span>
            </p>
        </div>
        ...
        <span class="md:flex-grow flex flex-col items-end justify-center">
            ...
            <span> Apply button clicks : <strong class="text-bold">{{$listing->clicks()->count() }}</strong>  </span>
        </span>
    </a>
