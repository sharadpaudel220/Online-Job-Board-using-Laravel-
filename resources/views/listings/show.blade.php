<x-app-layout>
    <section class="text-grey-600 body-font overflow-hidden">
                    ...
                    <div class="content w-full md:w-3/4 pr-4 leading-relaxed text-base ">
                        ...
                        <div class="w-full md:w-1/4 pl-4">
                            ...
                            src="/storage/{{$listing->logo}}"
                             ...
                             <a href="{{route('listing.apply', $listing->slug)}}" class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Apply Now</a>
                        </div>
